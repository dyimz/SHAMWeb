...
class TeacherController extends Controller
{
    ...
    {   
        ...
        return View::make('teacher.editProfile', compact('teacher', 'strands'));
    }
    ...
    public function studentList(Request $request)
    {
        ...
        $subject = Teacher_Curriculum::with('section')->with('curriculum')->find($request->curriculum_id);
        // dd($subject);
        $students = Student::with('section')->where('section_id', $subject->section_id)->orderBy('lname')->get();
        $students = Student_Curriculum::with('student')->with('section')
        ...
        // ->where('year_id', $taon)
        // ->where('semester_id', $subject->semester_id)
        // ->orWhereHas('student', function ($query) use ($subject) {
        //     $query->where('status', '=', 'irregular');
        // })
        // ->orWhereHas('student', function ($query) use ($subject) {
        //     $query->where('section_id', '=', $subject->section_id);
        // })
        // ->get()
        // ->sortBy(function ($grade) {
        //     return $grade->student->lname;
        // });
    ...
    public function viewGrades($teach_curr, $section_id, ){
        ...
        return View::make('teacher.viewGrades', compact('subject', 'teach_curr', 'grades'));
    }
