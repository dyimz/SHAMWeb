...
class UserController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $find = User::where('email', $request->email)->get()->last();
        // dd($request);
        ...
        elseif($find->status == 'disable'){
           return redirect()->back()->withErrors(['message' => 'User is disabled.']);
        }
        else{
    ...
    public function reports(){
        ...
        return view('admin.reports',compact(
            'mortality', 'male', 'female', 'version', 'drill', 'year', 'students', 'years'
        ));
    ...
    public function dashboard(){
        ...
        return view('admin.dashboard',compact(
            ...
            'register', 'countapplicants', 'countshortlisteds', 'countstudents', 'year', 'start', 'end',
    ...
    public function pdfMortality()
    {
        ...
        compact('mortality','pic1','pic2', 'year'))
    ...
    public function pdfRisk()
    {
        ...
        compact('risk','pic1','pic2', 'strand', 'year'))
        ->setPaper('a4', 'landscape');
    ...
    public function pdfStudentYear()
    {
        ...
        compact('pic1','pic2', 'students', 'years','year'))
        ->setPaper('a4', 'landscape');
    ...
    public function pdfDemographics()
    {
        ...
        compact('pic1','pic2', 'male', 'female', 'strands','year'))
        ->setPaper('a4', 'landscape');
    ...
    public function pdfABM()
    {
        ...
        $wait = Applicant::where('firstchoice', 'Accountancy, Business and Management')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->wabm)->get();
        ...
        compact('app','pic1','pic2', 'year', 'strand', 'wait'))
    ...
    public function pdfGAS()
    {
        ...
        $wait = Applicant::where('firstchoice', 'General Academic')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->wgas)->get();
    ...
    public function pdfHUMSS()
    {
        ...
        $wait = Applicant::where('firstchoice', 'Humanities and Social Sciences')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->whumss)->get();
    ...
    public function pdfSTEM()
    {
        ...
        $reg = Registration::where('year_id', $taon)->get()->first();
        $app = Applicant::where('firstchoice', 'Science, Technology, Engineering and Mathematics')->where('year_id', $taon)->orderByDesc('gwa')->orderBy('created_at', 'DESC')->take($reg->stem)->get();
        $wait = Applicant::where('firstchoice', 'Science, Technology, Engineering and Mathematics')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->wstem)->get();
    ...
    public function pdfCARE()
    {
        ...
        $reg = Registration::where('year_id', $taon)->get()->first();
        $app = Applicant::where('firstchoice', 'Caregiving (Nursing Arts)')->where('year_id', $taon)->orderByDesc('gwa')->orderBy('created_at', 'DESC')->take($reg->care)->get();
        $wait = Applicant::where('firstchoice', 'Caregiving (Nursing Arts)')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->wcare)->get();
    ...
    public function pdfEIM()
    {
        ...
        $reg = Registration::where('year_id', $taon)->get()->first();
        $app = Applicant::where('firstchoice', 'Electrical Installation and Maintenance')->where('year_id', $taon)->orderByDesc('gwa')->orderBy('created_at', 'DESC')->take($reg->eim)->get();
        $wait = Applicant::where('firstchoice', 'Electrical Installation and Maintenance')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->weim)->get();
    ...
    public function pdfHE()
    {
        ...
        $reg = Registration::where('year_id', $taon)->get()->first();
        $app = Applicant::where('firstchoice', 'Home Economics')->where('year_id', $taon)->orderByDesc('gwa')->orderBy('created_at', 'DESC')->take($reg->he)->get();
        $wait = Applicant::where('firstchoice', 'Home Economics')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->whe)->get();
    ...
    public function pdfICT()
    {
        ...
        $reg = Registration::where('year_id', $taon)->get()->first();
        $app = Applicant::where('firstchoice', 'Information and Communications Technology')->where('year_id', $taon)->orderByDesc('gwa')->orderBy('created_at', 'DESC')->take($reg->ict)->get();
        $wait = Applicant::where('firstchoice', 'Information and Communications Technology')->where('year_id', $taon)->whereNotIn('id', $app->pluck('id'))->orderByDesc('gwa')->orderBy('created_at', 'DESC')->skip($app->count())->take($reg->wict)->get();
