...
<form id="removeForm" action="{{ route('shortlisteds.destroy',$_id) }}" method="POST" style="padding:2px">
        @csrf
        @method('DELETE')
  <button type="button" onclick="confirmAndSubmitForm()" class="btn btn-danger btn-fab btn-icon btn-round"><i class="ti-trash" data-toggle="tooltip" title="Remove"></i></button>
</form>
