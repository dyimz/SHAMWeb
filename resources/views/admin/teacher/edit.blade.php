	...
	<div class="row">
      ...
      <div class="card">
	      <div class="card-header">
	        <h4 class="card-title">Edit a record</h4>
	      </div>
	      
        <div class="card-content">
        {{ Form::model($teacher, ['method' => 'PATCH', 'route' => ['teachers.update', $teacher->_id], 'files' => true, 'enctype' => 'multipart/form-data', 'id'=>'editTeacher']) }}
            @csrf
            <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    {!! Form::select('civilstatus', ['SINGLE' => 'SINGLE', 'MARRIED' => 'MARRIED', 'DIVORCED' => 'DIVORCED', 'SEPARATED' => 'SEPARATED', 'WIDOWED' => 'WIDOWED'], null,['placeholder' => 'Select the appropriate information','class' => 'form-control', 'required' => 'true']) !!}
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    {!! Form::select('coordinator', $strands, $user->role,['placeholder' => 'TEACHER', 'class' => 'form-control','id'=>'coordinator']) !!}              
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="file" id="image" name="image" value="{{old('image')}}" placeholder="Upload image" >
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-12" >
                  <div class="form-group pull-right">
                    ...
                    <a href="/admin/teachers" class="btn btn-wd" role="button">Cancel</a>
                  </div>
                </div> 
              </div>
