...
<form id="removeForm" action="{{ route('teachers.destroy',$_id) }}" method="POST" style="padding:2px">
        @csrf
        @method('DELETE')
  <button type="button" onclick="confirmAndSubmitForm()" class="btn btn-danger btn-fab btn-icon btn-round"><i class="ti-trash" data-toggle="tooltip" title="Delete"></i></button>
</form>
