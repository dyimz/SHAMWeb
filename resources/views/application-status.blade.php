                        ...
                        <div class="card">
                            <div class="">
                                <div class="card-header">
                                    <br>
                                    <h3 class="card-title text-center" ><b>CHECK YOUR APPLICATION STATUS</b></h3><br>
                                    <h4 class="card-title text-center" >Enter you application number here:</h04><br>
                                    ...
                                    <div class="text-center">
                                        <div class="navbar-form navbar-search-form" role="search">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="_id" value="" class="form-control" placeholder="Search...">
                                                
                                            </div>
                                        
                                            <button type="submit" class="btn btn-wd btn-warning btn-fill btn-magnify">
